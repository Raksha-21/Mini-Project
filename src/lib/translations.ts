...
export const translations: Translation = {
  ...
  phone: { en: "Phone Number", hi: "फोन नंबर", kn: "ದೂರವಾಣಿ ಸಂಖ್ಯೆ" },
  ...
  newUser: { en: "New User", hi: "नया उपयोगकर्ता", kn: "ಹೊಸ ಬಳಕೆದಾರ" },
  forgotPassword: {
    en: "Forgot Password?",
    hi: "पासवर्ड भूल गए?",
  ...
  aiRoadmap: { en: "AI Roadmap", hi: "AI रोडमैप", kn: "AI ಮಾರ್ಗಸೂಚಿ" },
  Schemes: { en: "Schemes", hi: "योजनाएँ", kn: "ಯೋಜನೆಗಳು" },
  Disease: { en: "Disease Detection", hi: "रोग पहचान", kn: "ರೋಗ ಪತ್ತೆ" },
  voiceChatbot: {
    en: "Voice Chatbot",
    hi: "आवाज़ चैटबॉट",
    kn: "ಧ್ವನಿ ಚಾಟ್‌ಬಾಟ್",
  ...
  scanDetect: { en: "Scan & Detect", hi: "स्कैन और पहचान", kn: "ಸ್ಕ್ಯಾನ್ ಮತ್ತು ಪತ್ತೆ" },
  taskPlanner: { en: "Task Planner", hi: "कार्य योजनाकार", kn: "ಕಾರ್ಯ ಯೋಜಕ" },
  aiAssistant: { en: "AI Assistant", hi: "AI सहायक", kn: "AI ಸಹಾಯಕ" },
  reports: { en: "Reports", hi: "रिपोर्ट", kn: "ವರದಿಗಳು" },

  // ---------- HOME GARDENER ----------
  myPlants: { en: "My Plants", hi: "मेरे पौधे", kn: "ನನ್ನ ಸಸ್ಯಗಳು" },
  detectDisease: {
    en: "Detect Disease",
    hi: "बीमारी का पता लगाएं",
    kn: "ರೋಗವನ್ನು ಪತ್ತೆಮಾಡಿ",
  },
  tips: { en: "Tips", hi: "सुझाव", kn: "ಸಲಹೆಗಳು" },
  reminders: { en: "Reminders", hi: "अनुस्मारक", kn: "ಜ್ಞಾಪನೆಗಳು" },
  calendar: { en: "Calendar", hi: "कैलेंडर", kn: "ಕ್ಯಾಲೆಂಡರ್" },
  ...
  verifyOtp: { en: "Verify OTP", hi: "OTP सत्यापित करें", kn: "OTP ಪರಿಶೀಲಿಸಿ" },
};

/**
 * Get translated text based on language
 * @param key - translation key
 * @param language - current language ("en" | "hi" | "kn")
 */
